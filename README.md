...
const anmol = {
    ...
    askMeAbout: ["web dev", "tech", "app dev", "full stack dev"],
    technologies: {
        backEnd: {
            js: ["Node", "Fastify", "Express"],
        },
        frontEnd: {
            js: ["React", "Redux", "Gatsby", "Next"],
        },
...
---
<!--START_SECTION:waka-->
![Code Time](http://img.shields.io/badge/Code%20Time-2%12C131%20hrs%2011%20mins-blue)
